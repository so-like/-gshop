  ...
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back" @click="$router.back()">
        <i class="iconfont icon-htmal5icon37"/>
      </a>
    </nav>
    <div class="shop-content" @click="getshopShow">
    ...
    <!-- info.supports有值才会解析 因为它的初始值为空 -->
    <!-- v-if是不解析不显示 v-show是解析不显示 -->
    <div class="shop-header-discounts" v-if="info.supports" @click="getSupportShow">
